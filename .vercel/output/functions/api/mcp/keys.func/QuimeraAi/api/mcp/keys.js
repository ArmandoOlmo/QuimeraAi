...
import { assertUserTenantAccess, createMcpApiKey, normalizeRequestedScopes, requireSupabaseUser, } from '../_lib/mcpKeys.js';
...
async function countCallsLast30Days(apiKeyId) {
...
export default async function handler(req, res) {
    ...
    try {
        ...
        if (action === 'create') {
            ...
            if (scopes.length === 0)
                throw Object.assign(new Error('At least one valid scope is required.'), { status: 400 });
