import { createAiStudioMetadata, getBriefText, } from './types';
function blockTitle(type, businessName) {
    switch (type) {
...
function makeBlock(type, index, input, source, enabled = true) {
...
export function deriveWebsiteEcommerceBlocks(input, ecommerceBlueprint, storefrontBlueprint) {
    if (!ecommerceBlueprint.enabled || !storefrontBlueprint.enabled)
        return [];
...
//# sourceMappingURL=deriveWebsiteEcommerceBlocks.js.map