const slot = (id, label, kind, required = false, dataPath) => ({
    id,
    label,
    kind,
    required,
...
const variant = (id, label, description, recommendedSlots, bestForPageIntents, bestForIndustries = ['all'], mobileBehavior = 'stackedMobile', avoidWhen = []) => ({
    id,
    label,
    description,
    recommendedSlots,
...
const style = (id, label, description, bestForIndustries = ['all']) => ({
    id,
    label,
    description,
    bestForIndustries,
...
const controls = (slots) => slots.map(slotId => ({
    slotId,
...
export const componentAnatomyRegistry = {
    header: anatomy({
        componentId: 'header',
...
export const getComponentAnatomy = (componentId) => (componentAnatomyRegistry[componentId]);
export const isComponentLayoutVariant = (componentId, layoutVariant) => (Boolean(getComponentAnatomy(componentId)?.layoutVariants.some(variant => variant.id === layoutVariant)));
export const getDefaultComponentLayoutVariant = (componentId) => (getComponentAnatomy(componentId)?.defaultVariant);
//# sourceMappingURL=componentAnatomyRegistry.js.map