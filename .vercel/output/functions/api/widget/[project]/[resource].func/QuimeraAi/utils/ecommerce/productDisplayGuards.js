...
export const getSafeProductTitle = (product) => {
...
const hasExplicitFreePrice = (product) => {
    if (!isRecord(product))
        return false;
...
const isTechnicalFallbackProduct = (product) => {
    if (!isRecord(product))
        return true;
...
export const getSafeProductPrice = (product, options = {}) => {
...
export const getSafeDiscountBadge = (product) => {
...
export const isRenderableStorefrontProduct = (product, options = {}) => {
    if (isTechnicalFallbackProduct(product))
        return false;
    if (!getSafeProductId(product))
        return false;
    if (!getSafeProductTitle(product))
        return false;
...
export const filterRenderableStorefrontProducts = (products, options = {}) => products.filter(product => isRenderableStorefrontProduct(product, options));
//# sourceMappingURL=productDisplayGuards.js.map