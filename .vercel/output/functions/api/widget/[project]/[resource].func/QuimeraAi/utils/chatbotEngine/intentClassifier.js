import { buildChatbotEngineSurfaceContext } from './surfaceContext.js';
const RULES = [
    {
...
function hasContactSignal(value) {
...
function scoreRule(rule, text, surface) {
...
export function classifyChatbotMessageIntent(input) {
