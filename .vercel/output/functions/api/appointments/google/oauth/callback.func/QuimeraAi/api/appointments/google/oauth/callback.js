...
import { assertGoogleCalendarProjectAccess, createOrRenewGoogleCalendarWatch, exchangeGoogleCalendarCode, syncGoogleCalendarIntegration, upsertGoogleCalendarIntegration, verifyGoogleCalendarOAuthState, } from '../../../../services/appointments/appointmentGoogleCalendarSyncService.js';
import { googleRedirectUri, redirectWithStatus, requestOrigin, safeReturnUrl, send, } from '../_lib.js';
...
export default async function handler(req, res) {
    ...
    try {
        ...
        if (!stateSecret)
            throw Object.assign(new Error('GOOGLE_CALENDAR_OAUTH_STATE_SECRET is not configured.'), { status: 500 });
