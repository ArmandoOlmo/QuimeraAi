        ...
        >
            ...
            <div className="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p className="text-sm text-editor-text-secondary">Top 10 clientes por ingresos</p>
                </div>
                <div className="flex items-center gap-2 text-editor-text-secondary">
                    <Users className="w-5 h-5" />
                    <span className="text-sm">{data.length} clientes</span>
                </div>
            </div>
            ...
            <div className="mt-4 pt-4 border-t border-editor-border flex justify-between items-center">
                <span className="text-sm text-editor-text-secondary">Total MRR</span>
