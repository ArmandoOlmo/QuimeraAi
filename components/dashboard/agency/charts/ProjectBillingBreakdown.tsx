            ...
            <div className="space-y-4">
                ...
                >
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="font-medium text-editor-text-primary">Fee Base Mensual</p>
                            <p className="text-xs text-editor-text-secondary">Cargo fijo del plan</p>
                        </div>
                    </div>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-editor-text-secondary">
                                    {totalProjects} proyectos × {formatCurrency(projectCost)}
                                </p>
                            </div>
                        </div>
                        <span className="text-lg font-semibold text-editor-text-primary">
                        ...
                        <div className="mt-3 pt-3 border-t border-editor-border space-y-2">
                            ...
                            {breakdown.filter((c) => c.projectCount > 0).length > 5 && (
                                <p className="text-xs text-editor-text-secondary text-center pt-2">
                                    +{breakdown.filter((c) => c.projectCount > 0).length - 5} más...
                                </p>
                            )}
                        </div>
                    )}
                ...
                >
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="font-semibold text-editor-text-primary">Total Mensual</p>
                            <p className="text-xs text-editor-text-secondary">
