            ...
            return (
                <div className="bg-editor-panel-bg border border-editor-border rounded-lg p-3 shadow-lg">
                    ...
                    <p className="text-sm" style={{ color: data.payload.fill }}>
                        {data.value.toLocaleString()} créditos ({percentage}%)
                    </p>
                </div>
            );
        }
    ...
    return (
        ...
        >
            ...
            <div className="relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <div className="text-center">
                        ...
                        <div className="text-xs text-editor-text-secondary">usado</div>
                    </div>
                </div>
            </div>
            ...
            <div className="mt-4 pt-4 border-t border-editor-border grid grid-cols-2 gap-4">
                <div>
                    <p className="text-xs text-editor-text-secondary">Usados</p>
                    <p className="text-lg font-semibold text-purple-400">
                        {poolUsed.toLocaleString()}
                    </p>
                </div>
                <div>
                    <p className="text-xs text-editor-text-secondary">Disponibles</p>
