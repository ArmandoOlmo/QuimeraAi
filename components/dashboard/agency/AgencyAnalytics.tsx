        ...
        <div className="space-y-6">
            ...
            >
                <div>
                    ...
                    <p className="text-editor-text-secondary mt-1">
                        Métricas y rendimiento de tu agencia
                    </p>
                </div>
            ...
            >
                <div className="bg-editor-panel-bg border border-editor-border rounded-xl p-4">
                    <p className="text-sm text-editor-text-secondary">MRR Total</p>
                    <p className="text-2xl font-bold text-emerald-400">
                        ${aggregatedMetrics.mrr.toLocaleString()}
                    </p>
                </div>
                <div className="bg-editor-panel-bg border border-editor-border rounded-xl p-4">
                    <p className="text-sm text-editor-text-secondary">Clientes Activos</p>
                    <p className="text-2xl font-bold text-blue-400">
                        {aggregatedMetrics.activeSubClients}
                    </p>
                </div>
                <div className="bg-editor-panel-bg border border-editor-border rounded-xl p-4">
                    <p className="text-sm text-editor-text-secondary">Proyectos</p>
                    <p className="text-2xl font-bold text-purple-400">
                        {aggregatedMetrics.totalProjects}
                    </p>
                </div>
                <div className="bg-editor-panel-bg border border-editor-border rounded-xl p-4">
                    <p className="text-sm text-editor-text-secondary">AI Credits Usados</p>
