...
const AdminProfileView: React.FC<AdminProfileViewProps> = ({ user, onBack }) => {
    ...
    return (
        <AdminViewLayout title={`Perfil de ${user.name}`} onBack={onBack}>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-editor-panel-bg border border-editor-border rounded-xl p-6 shadow-sm">
                            ...
                            <div className="space-y-4">
                                <div>
                                    <label className="block text-sm font-medium text-editor-text-secondary mb-1.5">Nombre</label>
                                    <input
                                        type="text"
                                        value={name}
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-editor-text-secondary mb-1.5">Email</label>
                                    <input
                                        type="email"
                                        value={user.email}
                                        readOnly
                                    ...
                                    />
                                    <p className="text-xs text-editor-text-secondary mt-1">El email no puede ser modificado</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-editor-panel-bg border border-editor-border rounded-xl p-6 shadow-sm">
                            ...
                            {!canEditRole && (
                                <div className="mb-4 p-3 bg-yellow-500/10 border border-yellow-500/20 rounded-lg text-sm text-yellow-300">
                                    {isTargetOwner
                                        ? 'El rol de Owner no puede ser modificado.'
                        ...
                        {canDelete && (
                            <div className="bg-red-500/5 border border-red-500/20 rounded-xl p-6">
                                ...
                                <p className="text-sm text-editor-text-secondary mb-4">
                                    Esta acción eliminará permanentemente al usuario y revocará todos sus accesos.
                                </p>
                                <button
