...
const ContentManagementDashboard: React.FC<ContentManagementDashboardProps> = ({ onBack }) => {
    ...
    const handleDelete = async (id: string) => {
        if (window.confirm(t('contentManagement.deleteConfirm', '¿Estás seguro de eliminar este artículo?'))) {
    ...
    const handleBulkDelete = async () => {
        if (window.confirm(t('contentManagement.confirmBulkDelete', { count: selectedArticles.length }))) {
