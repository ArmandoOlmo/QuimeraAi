...
const EditorHeader: React.FC = () => {
  ...
  const [projectName, setProjectName] = useState(activeProject?.name || 'Untitled Project');
    ...
    <header className="bg-editor-bg border-b border-editor-border h-[65px] flex-shrink-0 z-20">
      <div className="mx-auto px-4 sm:px-6 h-full flex justify-between items-center">
        ...
        <div className="flex items-center space-x-2 sm:space-x-4">
           <ThemeToggle />
           <button
                title={saveState === 'idle' ? "Save Changes" : "Saved!"}
           ...
           >
                ...
                <span className="hidden sm:inline ml-2 font-semibold">{saveState === 'idle' ? "Save" : "Saved!"}</span>
           </button>
