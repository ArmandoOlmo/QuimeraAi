...
**Sitio web:** https://quimera.ai`,
        ...
        productFeatures: [
            ...
            { id: 'ecommerce-products', name: 'Gestión de Productos', description: 'Hasta 100 productos en Individual, 10,000 en Agency Scale y 50,000 en Enterprise. Variantes, categorías y precios de oferta.', icon: 'Package', includedInPlans: ['pro', 'agency', 'enterprise'] },
        ...
        pricingPlans: [
            ...
            },
            {
                ...
                features: [
                    ...
                    'Hasta 500 sub-clientes',
                    'Hasta 50,000 productos',
                    'Hasta 500,000 leads',
                    'Hasta 500,000 emails/mes',
                    '500 dominios',
                    'SLA garantizado',
