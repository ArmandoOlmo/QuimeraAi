...
export const INDUSTRY_COMPONENT_DEFAULTS: Record<string, {
    ...
    'restaurant': {
        ...
        optional: ['slideshow', 'team', 'faq', 'newsletter', 'banner', 'chatbot'],
        disabled: ['pricing', 'portfolio', 'howItWorks', 'features', 'services', 'cmsFeed'],
    },
    'cafe': {
        recommended: ['header', 'hero', 'menu', 'testimonials', 'map', 'leads', 'footer'],
        optional: ['slideshow', 'team', 'newsletter', 'banner', 'chatbot'],
        disabled: ['pricing', 'portfolio', 'howItWorks', 'features', 'services', 'faq', 'cmsFeed'],
    },
    'technology': {
        recommended: ['header', 'hero', 'features', 'pricing', 'testimonials', 'faq', 'cta', 'footer'],
        optional: ['team', 'portfolio', 'video', 'howItWorks', 'newsletter', 'cmsFeed', 'chatbot'],
        disabled: ['menu', 'map', 'services', 'banner', 'slideshow'],
    },
    'healthcare': {
        recommended: ['header', 'hero', 'services', 'team', 'testimonials', 'leads', 'map', 'footer'],
        optional: ['faq', 'newsletter', 'video', 'chatbot', 'cmsFeed'],
    ...
    'consulting': {
        ...
        optional: ['faq', 'portfolio', 'newsletter', 'video', 'cmsFeed', 'chatbot'],
    ...
    'ecommerce': {
        ...
        optional: ['video', 'howItWorks', 'team', 'cmsFeed', 'chatbot'],
    ...
    'fitness-gym': {
        ...
        optional: ['slideshow', 'video', 'faq', 'newsletter', 'cta', 'chatbot'],
        disabled: ['menu', 'portfolio', 'howItWorks', 'banner', 'cmsFeed'],
    },
    'photography': {
        recommended: ['header', 'hero', 'portfolio', 'testimonials', 'pricing', 'leads', 'footer'],
        optional: ['slideshow', 'video', 'faq', 'team', 'cmsFeed'],
    ...
    'real-estate': {
        ...
        optional: ['team', 'faq', 'video', 'slideshow', 'chatbot'],
        disabled: ['menu', 'pricing', 'howItWorks', 'newsletter', 'banner', 'cmsFeed'],
    },
    'beauty-spa': {
        recommended: ['header', 'hero', 'services', 'pricing', 'testimonials', 'team', 'leads', 'map', 'footer'],
        optional: ['slideshow', 'faq', 'newsletter', 'video', 'chatbot'],
        disabled: ['menu', 'portfolio', 'howItWorks', 'banner', 'cmsFeed'],
    },
    'automotive': {
        recommended: ['header', 'hero', 'services', 'portfolio', 'testimonials', 'leads', 'map', 'footer'],
        optional: ['team', 'faq', 'slideshow', 'video', 'chatbot'],
        disabled: ['menu', 'pricing', 'howItWorks', 'newsletter', 'banner', 'cmsFeed'],
    },
    'legal': {
        recommended: ['header', 'hero', 'services', 'team', 'testimonials', 'leads', 'footer'],
        optional: ['faq', 'portfolio', 'map', 'cmsFeed', 'chatbot'],
    ...
    'event-planning': {
        ...
        optional: ['team', 'faq', 'pricing', 'slideshow', 'video', 'chatbot'],
        disabled: ['menu', 'map', 'howItWorks', 'newsletter', 'banner', 'cmsFeed'],
    },
    'default': {
        recommended: ['header', 'hero', 'features', 'testimonials', 'cta', 'leads', 'footer'],
        optional: ['services', 'team', 'faq', 'newsletter', 'video', 'portfolio', 'cmsFeed', 'chatbot'],
