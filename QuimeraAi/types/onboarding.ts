...
export const INDUSTRY_COMPONENT_DEFAULTS: Record<string, {
    ...
    'healthcare': {
        ...
        optional: ['faq', 'newsletter', 'video', 'chatbot', 'cmsFeed', 'topBar', 'logoBanner', 'signupFloat'],
    ...
    'legal': {
        ...
        optional: ['faq', 'portfolio', 'map', 'cmsFeed', 'chatbot', 'topBar', 'logoBanner', 'signupFloat'],
    ...
    'finance': {
        ...
        optional: ['faq', 'cta', 'cmsFeed', 'chatbot', 'topBar', 'logoBanner', 'signupFloat'],
