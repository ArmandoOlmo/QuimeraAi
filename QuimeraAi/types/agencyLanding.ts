...
export const AGENCY_LANDING_COMPONENTS = [
    ...
    { type: 'heroGallery', label: 'Hero Galeria', category: 'content' },
    { type: 'heroWave', label: 'Hero Wave', category: 'content' },
    { type: 'heroNova', label: 'Hero Nova', category: 'content' },
    { type: 'heroLead', label: 'Hero con Lead Form', category: 'content' },
    { type: 'topBar', label: 'Top Bar', category: 'structure' },
    { type: 'logoBanner', label: 'Logo Banner', category: 'structure' },
    ...
    { type: 'showcase', label: 'Showcase', category: 'content' },
    ...
    { type: 'restaurantReservation', label: 'Reservaciones Restaurante', category: 'content' },
    { type: 'realEstateListings', label: 'Listados Realty', category: 'content' },
    { type: 'products', label: 'Productos', category: 'ecommerce' },
    { type: 'storeSettings', label: 'Configuración de Tienda', category: 'ecommerce' },
    { type: 'featuredProducts', label: 'Productos Destacados', category: 'ecommerce' },
    { type: 'categoryGrid', label: 'Categorías', category: 'ecommerce' },
    { type: 'productHero', label: 'Hero de Producto', category: 'ecommerce' },
    { type: 'saleCountdown', label: 'Cuenta Regresiva', category: 'ecommerce' },
    { type: 'trustBadges', label: 'Sellos de Confianza', category: 'ecommerce' },
    { type: 'recentlyViewed', label: 'Vistos Recientemente', category: 'ecommerce' },
    { type: 'productReviews', label: 'Reviews de Producto', category: 'ecommerce' },
    { type: 'collectionBanner', label: 'Banner de Colección', category: 'ecommerce' },
    { type: 'productBundle', label: 'Bundle de Productos', category: 'ecommerce' },
    { type: 'announcementBar', label: 'Barra de Anuncio', category: 'ecommerce' },
    { type: 'cmsFeed', label: 'Feed CMS', category: 'content' },
    { type: 'signupFloat', label: 'Signup Float', category: 'conversion' },
    { type: 'chatbot', label: 'Chatbot', category: 'conversion' },
    { type: 'separator1', label: 'Separador 1', category: 'structure' },
    { type: 'separator2', label: 'Separador 2', category: 'structure' },
    { type: 'separator3', label: 'Separador 3', category: 'structure' },
    { type: 'separator4', label: 'Separador 4', category: 'structure' },
    { type: 'separator5', label: 'Separador 5', category: 'structure' },
    { type: 'heroLumina', label: 'Hero Lumina', category: 'lumina' },
    { type: 'featuresLumina', label: 'Features Lumina', category: 'lumina' },
    { type: 'ctaLumina', label: 'CTA Lumina', category: 'lumina' },
    { type: 'portfolioLumina', label: 'Portfolio Lumina', category: 'lumina' },
    { type: 'pricingLumina', label: 'Pricing Lumina', category: 'lumina' },
    { type: 'testimonialsLumina', label: 'Testimonials Lumina', category: 'lumina' },
    { type: 'faqLumina', label: 'FAQ Lumina', category: 'lumina' },
    { type: 'heroNeon', label: 'Hero Neon', category: 'neon' },
    { type: 'testimonialsNeon', label: 'Testimonials Neon', category: 'neon' },
    { type: 'featuresNeon', label: 'Features Neon', category: 'neon' },
    { type: 'ctaNeon', label: 'CTA Neon', category: 'neon' },
    { type: 'portfolioNeon', label: 'Portfolio Neon', category: 'neon' },
    { type: 'pricingNeon', label: 'Pricing Neon', category: 'neon' },
    { type: 'faqNeon', label: 'FAQ Neon', category: 'neon' },
