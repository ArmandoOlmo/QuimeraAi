        ...
        {slides.map((slide: any, slideIndex: number) => (
          <div key={slideIndex} className="bg-q-bg p-4 rounded-lg border border-q-border mb-4">
            ...
            <AIFormControl label={t('controls.headline')} onAssistClick={() => setAiAssistField({ path: `heroWave.slides.${slideIndex}.headline`, value: slide.headline, context: 'Hero Wave Headline' })}>
              <I18nTextArea value={slide.headline || ''} onChange={(val) => setNestedData(`heroWave.slides.${slideIndex}.headline`, val)} rows={2} />
            </AIFormControl>
            ...
            <AIFormControl label={t('controls.subheadline')} onAssistClick={() => setAiAssistField({ path: `heroWave.slides.${slideIndex}.subheadline`, value: slide.subheadline || '', context: 'Hero Wave Subheadline' })}>
              <I18nInput label="" value={slide.subheadline || ''} onChange={(val) => setNestedData(`heroWave.slides.${slideIndex}.subheadline`, val)} />
            </AIFormControl>
            ...
            <div className="bg-q-surface/50 p-3 rounded-md border border-q-border mt-3">
              ...
              <div className="space-y-3">
                {/* Primary CTA */}
                <I18nInput label={t('controls.primaryCta')} value={slide.primaryCta || ''} onChange={(val) => setNestedData(`heroWave.slides.${slideIndex}.primaryCta`, val)} className="mb-0" />
                <div>
                  ...
                  <CtaLinkPicker
                    ...
                    onLinkTypeChange={(type) => setNestedData(`heroWave.slides.${slideIndex}.primaryCtaLinkType`, type)}
                    onLinkChange={(val) => setNestedData(`heroWave.slides.${slideIndex}.primaryCtaLink`, val)}
                ...
                <div className="pt-3 border-t border-q-border/40 space-y-3">
                  <I18nInput label={t('controls.secondaryCta')} value={slide.secondaryCta || ''} onChange={(val) => setNestedData(`heroWave.slides.${slideIndex}.secondaryCta`, val)} className="mb-0" />
                  <div>
                    ...
                    <CtaLinkPicker
                      ...
                      onLinkTypeChange={(type) => setNestedData(`heroWave.slides.${slideIndex}.secondaryCtaLinkType`, type)}
                      onLinkChange={(val) => setNestedData(`heroWave.slides.${slideIndex}.secondaryCtaLink`, val)}
