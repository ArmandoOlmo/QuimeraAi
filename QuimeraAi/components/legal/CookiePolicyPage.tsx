...
import { Shield, Lock, Eye, Database, Users, Mail, Globe, FileText, Settings, Clock, AlertTriangle, Loader2, Cookie } from 'lucide-react';
...
const CookiePolicyPage: React.FC = () => {
    ...
    useEffect(() => {
        const defaultPage = getDefaultLegalPage('cookie-policy', i18n.language);
        if (appContent) {
            const page = appContent.getLegalPageByType('cookie-policy', i18n.language as 'es' | 'en');
            ...
            <LegalPageLayout>
                <div className="flex items-center justify-center py-32">
                    <div className="text-center">
                        <Cookie className="w-16 h-16 mx-auto text-gray-700 mb-4" />
    ...
    return (
        <LegalPageLayout>
            <main className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
                ...
                {/* Quick Summary */}
                <div className="bg-yellow-400/5 border border-yellow-400/20 rounded-2xl p-6 mb-8">
