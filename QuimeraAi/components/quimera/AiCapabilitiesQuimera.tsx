...
const AiCapabilitiesQuimera: React.FC<AiCapabilitiesQuimeraProps> = ({
    ...
    const getDefaultCapabilities = (t: any) => [
        { icon: 'MessageSquare', title: t('quimera.aicapabilities.item1.title', 'Asistente Global Integrado'), description: t('quimera.aicapabilities.item1.desc', 'Un chatbot inteligente en tu panel de control listo para generar secciones enteras, escribir copys o sugerir paletas de colores.') },
        { icon: 'FileText', title: t('quimera.aicapabilities.item2.title', 'Copywriting Automatizado'), description: t('quimera.aicapabilities.item2.desc', 'Dile adiós al síndrome de la página en blanco. Nuestra IA redacta títulos persuasivos y descripciones de productos que convierten.') },
        { icon: 'ImageIcon', title: t('quimera.aicapabilities.item3.title', 'Sugerencias Visuales'), description: t('quimera.aicapabilities.item3.desc', 'Selección inteligente de imágenes de stock y generación de estilos CSS para que tu sitio siempre luzca profesional.') }
    ];

    const displayCapabilities = capabilities || getDefaultCapabilities(t);
    ...
    const displayTitle = title || t('quimera.aicapabilities.title', 'Impulsado por Inteligencia Artificial');
    const displaySubtitle = subtitle || t('quimera.aicapabilities.subtitle', 'Escribe el subtítulo aquí...');
                ...
                <div className="lg:w-1/2">
                    ...
                    <div className="space-y-6">
                        {displayCapabilities.map((cap, i) => {
                            const displayCapTitle = cap.title || t('quimera.aicapabilities.item.title', 'Título');
                            const displayCapDesc = cap.description || t('quimera.aicapabilities.item.desc', 'Descripción');
                            return (
                ...
                <div className="lg:w-1/2 w-full">
                    <div className="relative rounded-2xl border shadow-[0_0_50px_rgba(212,175,55,0.05)] overflow-hidden" style={{ backgroundColor: cardBg, borderColor: cardBorder }}>
                        ...
                        <div className="p-4 border-b flex items-center gap-3" style={{ borderColor: cardBorder, backgroundColor: 'rgba(255,255,255,0.02)' }}>
                            ...
                            <div>
                                <h4 className="font-bold text-sm font-header heading-caps">{t('quimera.aicapabilities.chatbot.name', 'Quimera AI')}</h4>
                                <p className="text-xs text-gray-500 font-body">{t('quimera.aicapabilities.chatbot.status', 'En línea')}</p>
                            </div>
                        </div>
                        ...
                        <div className="p-6 space-y-6 min-h-[300px]">
                            ...
                            <div className="flex justify-end animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
                                <div className="bg-white/10 rounded-2xl rounded-tr-sm px-4 py-3 max-w-[80%] text-sm font-body">
                                    {t('quimera.aicapabilities.chatbot.msg1', 'Crea una sección de Hero para una cafetería moderna. Usa tonos oscuros y dorados.')}
                                </div>
                            </div>
                            ...
                            <div className="flex justify-start items-end gap-2 animate-fade-in-up" style={{ animationDelay: '1.5s' }}>
                                ...
                                <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-2xl rounded-tl-sm px-4 py-3 max-w-[80%] text-sm text-yellow-200 font-body">
                                    <div className="flex items-center gap-2">
                                        ...
                                        {t('quimera.aicapabilities.chatbot.generating', 'Generando componente y copy...')}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex justify-start items-end gap-2 animate-fade-in-up" style={{ animationDelay: '3s', animationFillMode: 'both' }}>
                                ...
                                <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-2xl rounded-tl-sm p-4 w-[85%]">
                                    <p className="text-sm text-gray-300 mb-3 font-body">{t('quimera.aicapabilities.chatbot.ready', '¡Listo! He añadido la sección a tu página. Así es como se ve:')}</p>
                        ...
                        <div className="p-4 border-t border-white/10 bg-white/[0.02]">
                            <div className="relative">
                                <input 
                                    type="text" 
                                    disabled
                                    placeholder={t('quimera.aicapabilities.input.placeholder', 'Escribe tu prompt aquí...')} 
