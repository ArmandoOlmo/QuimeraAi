            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 auto-rows-[300px]">
                    ...
                    {features.map((feature, index) => {
                        if (index === 0) {
                            return (
                                <div key={index} className="md:col-span-2 md:row-span-2 group relative p-8 rounded-3xl bg-white/[0.02] border border-white/5 hover:border-yellow-500/30 hover:bg-white/[0.04] transition-all duration-500 overflow-hidden flex flex-col">
                        ...
                        if (index === 1) {
                            return (
                                <div key={index} className="md:col-span-2 group relative p-8 rounded-3xl bg-white/[0.02] border border-white/5 hover:border-yellow-500/30 hover:bg-white/[0.04] transition-all duration-500 overflow-hidden flex flex-col">
                        ...
                        return (
                            <div key={index} className="md:col-span-1 group relative p-8 rounded-3xl bg-white/[0.02] border border-white/5 hover:border-yellow-500/30 hover:bg-white/[0.04] transition-all duration-500 overflow-hidden">
