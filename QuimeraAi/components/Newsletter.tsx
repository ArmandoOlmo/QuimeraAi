...
const Newsletter: React.FC<NewsletterProps> = ({
  glassEffect, title, description, placeholderText, buttonText, paddingY, paddingX, colors, cardBorderRadius = 'xl', buttonBorderRadius = 'xl', titleFontSize = 'md', descriptionFontSize = 'md', cardOpacity, showCardBorder, cardPadding, cardPaddingTop, cardPaddingRight, cardPaddingBottom, cardPaddingLeft }) => {
