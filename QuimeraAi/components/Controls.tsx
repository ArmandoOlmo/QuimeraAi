...
const Controls: React.FC = () => {
  ...
  // ─── Logo Banner Controls ───
  const renderLogoBannerControls = () => {
  ...
  const sectionConfig: Record<PageSection, { label: string, icon: React.ElementType, renderer: () => React.ReactNode }> = {
    ...
    heroWave: { label: 'Hero Wave', icon: Waves, renderer: renderHeroWaveControls },
    heroNova: { label: 'Hero Nova', icon: MonitorPlay, renderer: renderHeroNovaControls },
    ...
    logoBanner: { label: 'Logo Banner', icon: Layers, renderer: renderLogoBannerControls },
  ...
  const renderLeadsControlsWithTabs = () => {
    ...
    const styleTab = (
      <div className="space-y-4">
        ...
        <div className="bg-editor-panel-bg/50 p-4 rounded-lg border border-editor-border space-y-2">
          <label className="block text-xs font-bold text-editor-text-secondary uppercase tracking-wider">Border Radius</label>
        ...
        {/* Input Colors */}
        <div className="bg-editor-panel-bg/50 p-4 rounded-lg border border-editor-border space-y-2">
          <label className="block text-xs font-bold text-editor-text-secondary uppercase tracking-wider">Input Colors</label>
        ...
        <div className="bg-editor-panel-bg/50 p-4 rounded-lg border border-editor-border space-y-2">
          <label className="block text-xs font-bold text-editor-text-secondary uppercase tracking-wider">Button & Gradient</label>
  ...
  const renderMenuControlsWithTabs = () => {
    ...
    const contentTab = (
      <div className="space-y-4">
        ...
        {/* Content Controls */}
        <div className="space-y-3">
          <label className="block text-xs font-bold text-editor-text-secondary uppercase tracking-wider">Content</label>
        ...
        {/* Section Icon */}
        <div className="space-y-3">
          <label className="block text-xs font-bold text-editor-text-secondary uppercase tracking-wider">Section Icon</label>
          <ToggleControl
  ...
  // --- Signup Float controls organized into Content/Style tabs ---
  const renderSignupFloatControlsWithTabs = () => {
  ...
  const renderActiveSectionControls = () => {
    ...
    switch (activeSection) {
      ...
      case 'logoBanner':
        return renderLogoBannerControls();
      case 'map':
      ...
      case 'signupFloat':
        return renderSignupFloatControlsWithTabs();
      default:
