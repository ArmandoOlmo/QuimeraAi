      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          {tiers.slice(0, 2).map((tier, index) => (
            <div key={`${tier.name}-${index}`} className={clsx('p-10 md:p-14', cardRadius, animated(index).className)} style={{ ...animated(index).style, ...cardPaddingStyle, backgroundColor: index === 0 ? '#000000' : hexToRgba('#000000', 0.2), color: '#ffffff' }}>
