...
export const CreditOperationBadge: React.FC<CreditOperationBadgeProps> = ({
    ...
    const operationIcons: Record<AiCreditOperation, React.ReactNode> = {
        ...
        video_generation_seedance: <Film className="w-3 h-3" />,
        video_generation_veo: <Film className="w-3 h-3" />,
        video_generation_omni: <Film className="w-3 h-3" />,
    ...
    const operationLabels: Record<AiCreditOperation, string> = {
        ...
        video_generation_seedance: t('credits.opVideoSeedance'),
        video_generation_veo: t('credits.opVideoVeo'),
        video_generation_omni: t('credits.opVideoOmni'),
