              ...
              <button
                ...
                className={[
                  ...
                  isActive
                    ...
                    : 'bg-muted text-q-text-muted border-q-border hover:bg-muted/70 hover:text-foreground',
                ].join(' ')}
    ...
    <div className={`relative ${className}`} ref={dropdownRef}>
      ...
      {isOpen && (
        <>
          ...
          {/* Dropdown */}
          <div className="absolute right-0 top-full mt-2 w-52 bg-q-surface border border-q-border rounded-xl shadow-2xl z-50 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
            {/* Header */}
            <div className="px-4 py-2.5 border-b border-q-border/50 bg-secondary/30">
              ...
              {languages.map((lang) => (
                ...
                >
                  ...
                  <div className="flex flex-col items-start flex-1">
                    ...
                    <span className="text-xs text-q-text-muted">{lang.shortName}</span>
                  </div>
                  {i18n.language === lang.code && (
