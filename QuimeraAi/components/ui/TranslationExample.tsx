...
const TranslationExample: React.FC = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-q-bg-secondary rounded-xl border border-q-border">
      ...
      {/* Sección de Profile */}
      <div className="bg-q-bg p-4 rounded-lg mb-4">
        <h2 className="text-xl font-semibold text-q-text mb-4 flex items-center gap-2">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-q-bg-secondary border border-q-border rounded-lg text-q-text focus:ring-2 focus:ring-q-accent outline-none"
            />
          </div>

          {/* Campo Email */}
          <div>
            <label className="block text-sm font-medium text-q-text-secondary mb-2 flex items-center gap-2">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-q-bg-secondary border border-q-border text-q-text-secondary rounded-lg hover:text-q-text hover:bg-q-surface-overlay transition-colors"
            >
              <X className="w-4 h-4" />
              {t('common.cancel')}
            </button>
      ...
      {/* Sección de Acciones */}
      <div className="bg-q-bg p-4 rounded-lg">
        <h3 className="text-lg font-semibold text-q-text mb-3">
