    ...
    return (
        <div className="mb-3" ref={containerRef}>
            ...
            <button
                ...
                className={`w-full flex items-center justify-between bg-editor-panel-bg border rounded-md px-3 py-2.5 text-base text-editor-text-primary transition-all cursor-pointer ${
                    isOpen
            ...
            >
                ...
                <ChevronDown className={`h-4 w-4 text-editor-text-secondary flex-shrink-0 ml-2 transition-transform ${isOpen ? 'rotate-180' : ''}`} />
            </button>
                    ...
                    <div className="absolute top-1 left-0 right-0 bg-editor-panel-bg border border-editor-border rounded-lg shadow-xl overflow-hidden">
                        ...
                        <div className="p-2 border-b border-editor-border">
                            <div className="relative">
                                <Search className="absolute left-2.5 top-1/2 -translate-y-1/2 h-5 w-5 text-editor-text-secondary" />
                                <input
                                    ref={searchRef}
                                    type="text"
                                    value={search}
                                    ...
                                    className="w-full bg-editor-bg border border-editor-border rounded-md pl-10 pr-3 py-2.5 text-base text-editor-text-primary placeholder:text-editor-text-secondary/50 focus:outline-none focus:ring-1 focus:ring-editor-accent"
                                />
                            </div>
                        </div>
                        ...
                        <div ref={listRef} className="max-h-64 overflow-y-auto overscroll-contain">
                            {filteredFonts.length === 0 ? (
                                <div className="px-3 py-4 text-sm text-editor-text-secondary text-center">
                                ...
                                filteredFonts.map(font => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            {isSelected && <Check className="h-4 w-4 flex-shrink-0 text-editor-accent" />}
                                        </button>
                                    );
                                })
                            )}
            ...
            {showPreview && (
                <div
                    className="mt-2 p-3 bg-editor-bg rounded-lg border border-editor-border"
                    style={{ fontFamily: selectedStack }}
                >
                    <p className="text-base text-editor-text-primary font-semibold">
