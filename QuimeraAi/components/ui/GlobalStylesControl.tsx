...
export const generateComponentColorMappings = (colors: GlobalColors): Record<string, Record<string, string>> => {
    return {
        hero: {
            ...
            text: contrastText(colors?.background),
            heading: contrastText(colors?.background),
        ...
        slideshow: {
            ...
            arrowText: contrastText(colors?.background),
            dotActive: contrastText(colors?.surface),
            dotInactive: hexToRgba(contrastText(colors?.surface), 0.5),
            captionBackground: hexToRgba(colors?.background, 0.8),
            captionText: contrastText(colors?.background),
        },
        pricing: {
            background: colors?.background,
            accent: colors?.accent,
        ...
        portfolio: {
            ...
            cardTitleColor: contrastText(colors?.background),
            cardTextColor: hexToRgba(contrastText(colors?.background), 0.9),
