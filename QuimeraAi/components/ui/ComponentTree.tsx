...
const ComponentTree: React.FC<ComponentTreeProps> = ({
    ...
    const sectionLabels: Partial<Record<PageSection, string>> = {
        ...
        showcase: t('editor.showcaseSection', 'Showcase'),
        ...
        separator1: t('editor.separator1Section', 'Separador 1'),
        separator2: t('editor.separator2Section', 'Separador 2'),
        separator3: t('editor.separator3Section', 'Separador 3'),
        separator4: t('editor.separator4Section', 'Separador 4'),
        separator5: t('editor.separator5Section', 'Separador 5'),
        // Dynamic page sections
