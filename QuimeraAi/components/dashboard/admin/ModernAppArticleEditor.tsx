...
"""${fullText}"""`;
 ...
 <header className="admin-dashboard-topbar quimera-dashboard-header-bar h-14 px-3 md:px-6 flex items-center justify-between z-20 sticky top-0 relative" role="banner">
                        ...
                        <aside className="w-80 bg-q-surface border-l border-q-border overflow-y-auto p-6 shrink-0 shadow-xl">
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <ImagePicker label="" value={featuredImage} onChange={setFeaturedImage} destination="admin" adminCategory="article" onRemove={() => setFeaturedImage('')} contentId={article?.id || ''} contentType="article" />
                                </div>
