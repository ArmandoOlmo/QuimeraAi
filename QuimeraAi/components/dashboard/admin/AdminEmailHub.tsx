                        ...
                        {[
                            {
                                ...
                                threshold: { good: 95, warn: 90 },
                                hint: '> 95% es excelente',
                            },
                            {
                                label: 'Tasa de Apertura',
                                value: parseFloat(String(stats.openRate || 0)),
                                threshold: { good: 20, warn: 12 },
                                hint: '> 20% es excelente',
                            },
                            {
                                label: 'Tasa de Rebote',
                                value: parseFloat(String(stats.bounceRate || 0)),
                                threshold: { good: 2, warn: 5 },
                                inverted: true,
                                hint: '< 2% es saludable',
                            },
                        ].map((metric, i) => {
