 ...
 * Asistente de IA para crear artículos del blog de Quimera (Super Admin)
 * Similar a ContentCreatorAssistant pero adaptado para AppArticle
 */
...
interface AppContentCreatorAssistantProps {
    onClose: () => void;
...
const CATEGORY_OPTIONS: { value: AppArticleCategory; label: string }[] = [
...
const AppContentCreatorAssistant: React.FC<AppContentCreatorAssistantProps> = ({ onClose, onArticleCreated }) => {
