    ...
    return (
        <div className="p-6 space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-2xl font-bold text-q-text mb-2">Accessibility Checker</h2>
                ...
                <div className="flex gap-3">
                    {reports.length > 0 && (
                        <button
                            ...
                            className="px-4 py-2 bg-q-bg border border-q-border text-q-text font-bold rounded-lg hover:bg-q-surface-overlay transition-all flex items-center gap-2"
                        >
                            <Download size={20} />
                            Export Report
                        </button>
                    ...
                    <button
                        ...
                        className="px-3 py-2 text-q-accent font-bold hover:text-q-accent/80 transition-all flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        <Play size={20} />
            ...
            {reports.length > 0 && (
                <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                    <div className="p-4 bg-q-surface border border-q-border rounded-lg">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div className="text-sm text-q-text-secondary">Avg. Score</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-4 bg-q-surface border border-q-border rounded-lg">
                        <div className="flex items-center gap-3">
                            <CheckCircle size={24} className="text-q-accent" />
                            <div>
                                <div className="text-2xl font-bold text-q-text">{stats.componentsScanned}</div>
                                <div className="text-sm text-q-text-secondary">Components</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    {reports.map((report) => (
                        <div
                            ...
                            className="bg-q-surface border border-q-border rounded-lg overflow-hidden"
                        >
                            {/* Report Header */}
                            <div
                                className="p-4 cursor-pointer hover:bg-q-bg transition-colors flex items-center justify-between"
                                onClick={() =>
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-bold text-q-text">
                            ...
                            {selectedComponent === report.componentId && report.issues.length > 0 && (
                                <div className="border-t border-q-border p-4 space-y-3 bg-q-bg">
                                    {report.issues.map((issue) => (
                                        <div
                                            key={issue.id}
                                            className="p-4 bg-q-surface border border-q-border rounded-lg"
                                        >
                                            <div className="flex items-start gap-3 mb-2">
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <p className="text-q-text font-medium mb-1">
                                                        {issue.message}
                                                    </p>
                                                    {issue.element && (
            ...
            {reports.length === 0 && activeProject && (
                <div className="text-center py-16">
                    <Shield size={64} className="mx-auto text-q-text-secondary opacity-50 mb-4" />
                    ...
                    <button
                        onClick={runFullScan}
                        className="px-4 py-3 text-q-accent font-bold hover:text-q-accent/80 transition-all flex items-center gap-2 mx-auto"
                    >
                        <Play size={20} />
