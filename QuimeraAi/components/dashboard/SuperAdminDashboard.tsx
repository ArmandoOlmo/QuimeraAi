...
const SuperAdminDashboard = () => {
    ...
    const allAdminFeatures: AdminFeature[] = [
        ...
        // Content Management
        { id: 'news', title: t('superadmin.news.title', 'Noticias y Novedades'), description: t('superadmin.newsDesc', 'Gestionar noticias y actualizaciones para el dashboard'), icon: <Newspaper size={24} />, category: 'content', route: ROUTES.ADMIN_NEWS, isNew: true, allowedRoles: ['owner', 'superadmin', 'admin'] },
