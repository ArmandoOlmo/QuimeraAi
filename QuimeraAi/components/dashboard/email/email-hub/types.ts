/**
 * Types and constants for the User Email Hub
 * Adapted from admin/email-hub/types.ts — scoped to single user/project
 */
...
export interface UserEmailCampaign extends EmailCampaign {
    userId: string;
    projectId: string;
}

/** User-scoped audience */
export interface UserEmailAudience {
    id: string;
    name: string;
    description?: string;
...
export interface UserEmailHubProps {
    onBack: () => void;
}
...
export const AUTOMATION_TEMPLATES: AutomationTemplate[] = [
    {
        ...
        color: 'text-q-accent bg-q-accent/10',
        defaultDelay: 0,
    ...
    },
    {
        ...
        color: 'text-q-success bg-q-success/10',
        defaultDelay: 10080,
    ...
    },
    {
        ...
        color: 'text-q-warning bg-q-warning/10',
        defaultDelay: 7200,
        triggerEvent: 'order.delivered',
        category: 'engagement',
        defaultSteps: [
    ...
    },
    {
        ...
        color: 'text-q-text-muted bg-q-surface-overlay/10',
        defaultDelay: 129600,
