...
const OverviewTab: React.FC<OverviewTabProps> = ({
    ...
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {[
                { label: t('email.hub.overview.emailsSent'), value: stats.totalSent.toLocaleString(), icon: <Send size={20} />, color: 'text-q-accent bg-q-accent/10' },
                { label: t('email.hub.overview.openRate'), value: `${stats.openRate}%`, icon: <Eye size={20} />, color: 'text-q-accent bg-q-accent/10' },
                { label: t('email.hub.overview.clickRate'), value: `${stats.clickRate}%`, icon: <MousePointer size={20} />, color: 'text-q-accent bg-q-accent/10' },
                { label: t('email.hub.overview.activeCampaigns'), value: stats.activeCampaigns.toString(), icon: <Target size={20} />, color: 'text-q-success bg-q-success/10' },
                { label: t('email.hub.overview.totalContacts'), value: stats.totalContacts.toLocaleString(), icon: <Users size={20} />, color: 'text-q-accent bg-q-accent/10' },
                { label: t('email.hub.overview.deliveryRate'), value: `${stats.deliveryRate}%`, icon: <CheckCircle size={20} />, color: 'text-q-success bg-q-success/10' },
            ].map((kpi, i) => (
