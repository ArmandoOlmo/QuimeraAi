    ...
    return (
        <div className="min-h-screen bg-background flex">
            ...
            <div className="flex-1 flex flex-col min-h-screen">
                {/* Header */}
                <header className="h-14 w-full px-4 sm:px-6 border-b border-border flex items-center justify-between bg-card/50 backdrop-blur-md sticky top-0 z-40">
                    {/* Left: Menu & Title */}
                            ...
                            <div className="text-center py-16">
                                <div className="p-4 bg-muted/30 rounded-full w-fit mx-auto mb-6">
                                    {searchQuery ? (
                                        ...
                                        <Mail className="text-muted-foreground" size={48} />
                                    )}
                                </div>
