    ...
    return (
        <div className="min-h-screen bg-q-bg flex">
            ...
            <div className="flex-1 flex flex-col min-h-screen">
                {/* Header */}
                <header className="h-14 w-full px-4 sm:px-6 border-b border-q-border flex items-center justify-between bg-q-surface/50 backdrop-blur-md sticky top-0 z-40">
                    {/* Left: Menu & Title */}
