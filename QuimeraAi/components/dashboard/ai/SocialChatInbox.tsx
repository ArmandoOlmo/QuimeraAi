...
const SocialChatInbox: React.FC<SocialChatInboxProps> = ({
    ...
    const renderConversationList = () => (
        <div className="w-full lg:w-80 xl:w-96 border-r border-q-border flex flex-col bg-secondary/20">
            {/* Header */}
                ...
                {isLoading ? (
                    ...
                    conversations.map((conv) => (
                        <button
                            ...
                            className={`w-full p-4 border-b border-q-border text-left hover:bg-secondary/50 transition-colors ${
                        ...
                        >
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-xs text-q-text-muted truncate mt-0.5">
    ...
    const renderChatArea = () => {
        if (!activeConversation) {
            return (
                <div className="flex-1 flex flex-col items-center justify-center bg-secondary/10 text-q-text-muted">
        ...
        return (
            <div className="flex-1 flex flex-col bg-q-bg">
                ...
                {/* Input */}
                <div className="p-4 border-t border-q-border bg-q-surface">
                    <div className="flex items-end gap-2">
                        <div className="flex-1 relative">
                            <textarea
                                ...
                                rows={1}
                                className="w-full px-4 py-3 bg-secondary/50 border border-q-border rounded-xl resize-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all text-sm"
    ...
    return (
        <div className="h-full flex bg-q-bg">
            {/* Conversation List - Hidden on mobile when chat is active */}
            <div className={`${activeConversation ? 'hidden lg:flex' : 'flex'} flex-col bg-muted/30 border-r border-q-border`}>
