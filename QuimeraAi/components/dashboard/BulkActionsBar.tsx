...
const BulkActionsBar: React.FC<BulkActionsBarProps> = ({
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 animate-fade-in-up">
      <div className="bg-q-surface border-2 border-primary shadow-2xl shadow-primary/20 rounded-full px-6 py-3 flex items-center gap-4">
        {/* Selection count */}
        <div className="flex items-center gap-2 pr-4 border-r border-q-border">
        ...
        {/* Clear selection */}
        <div className="pl-4 border-l border-q-border">
          <button
