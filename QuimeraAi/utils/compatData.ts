...
const KNOWN_COLUMNS: Record<string, string[]> = {
    ...
    restaurants: ['id', 'tenant_id', 'owner_id', 'name', 'logo_url', 'hero_image_url', 'address', 'phone', 'cuisine_type', 'hours', 'reservation_enabled', 'max_party_size', 'reservation_interval', 'average_table_duration', 'languages_enabled', 'currency', 'service_fee', 'tax_rate', 'qr_menu_enabled', 'public_slug', 'created_at', 'updated_at'],
    ...
    restaurant_reservations: ['id', 'tenant_id', 'restaurant_id', 'customer_name', 'customer_email', 'customer_phone', 'date', 'time', 'party_size', 'table_preference', 'status', 'notes', 'source', 'created_at', 'updated_at'],
    ...
    email_logs: ['id', 'project_id', 'store_id', 'user_id', 'type', 'template_id', 'template_type', 'campaign_id', 'event_type', 'recipient_email', 'recipient_name', 'customer_id', 'subject', 'status', 'provider_message_id', 'provider', 'idempotency_key', 'open_count', 'click_count', 'bounce_type', 'bounce_message', 'error_message', 'error_code', 'order_id', 'lead_id', 'metadata', 'sent_at', 'delivered_at', 'opened_at', 'clicked_links', 'clicked_at', 'bounced_at', 'complained_at', 'created_at', 'updated_at'],
};
