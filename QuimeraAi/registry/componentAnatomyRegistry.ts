...
export const componentAnatomyRegistry: Record<ComponentId, ComponentAnatomyEntry> = {
    ...
    faq: anatomy({
        ...
        layoutVariants: [
            ...
            variant('editorialSplit', 'Editorial Split', 'Large headline with detailed right-side accordion.', ['headline', 'items'], ['ai_saas_landing', 'premium_brand_home']),
            variant('boxedList', 'Boxed List', 'Centered framed accordion for product FAQs.', ['headline', 'items'], ['ecommerce_home', 'service_landing']),
            variant('darkPanel', 'Dark Panel', 'Contained dark support panel with card rows.', ['headline', 'items'], ['ai_saas_landing', 'pricing']),
            variant('imageSplit', 'Image Split', 'Media panel paired with FAQ content.', ['headline', 'items', 'media'], ['premium_brand_home', 'portfolio_home']),
            variant('stackedCards', 'Stacked Cards', 'Intro column with stacked active answer cards.', ['headline', 'items'], ['service_landing', 'agency_home']),
            variant('answerPanel', 'Answer Panel', 'Question selector with persistent answer panel.', ['headline', 'items'], ['fintech_landing', 'support_page']),
            variant('contactCard', 'Contact Card', 'FAQ list with adjacent support card.', ['headline', 'items', 'cta'], ['lead_capture', 'agency_home']),
        ],
