...
const COMMAND_GUIDE_TARGETS: Record<string, string> = {
    ...
    'action:use-agency': 'open_agency',
    'action:agency-create-client': 'create_agency_client',
    'action:agency-client-360': 'open_agency_client_360',
    'action:agency-search-clients': 'search_agency_clients',
    'action:agency-performance-summary': 'summarize_agency_performance',
    'action:agency-create-report': 'create_agency_report',
    'action:agency-transfer-project': 'transfer_agency_project',
