...
const ACTION_COMMANDS: GlobalCommandItem[] = [
    ...
    actionCommand(
        ...
        'Use Agency Engine to provision a managed client with AI Studio, BusinessBlueprint, modules, billing setup, and a canonical service plan.',
        'Create a new agency client with AI provisioning',
        { assistantModule: 'agency', serviceId: 'agency', keywords: ['create agency client', 'new agency client', 'nuevo cliente agencia', 'crear cliente agencia', 'provision client', 'onboarding cliente', 'ai provisioning', 'businessblueprint', 'service plan', 'selected plan'] },
    ),
    actionCommand(
        'action:agency-client-360',
        'Open Client 360',
        'Use Agency Engine to search managed clients and open Client 360 context.',
        'Open Client 360 for an agency client',
        { assistantModule: 'agency', serviceId: 'agency', keywords: ['client 360', 'cliente 360', 'agency client', 'managed client', 'buscar cliente', 'client workspace', 'client context'] },
    ),
    actionCommand(
        'action:agency-search-clients',
        'Search Agency Clients',
        'Use Agency Engine to search managed clients by name, email, lifecycle, billing mode, or service plan.',
        'Search agency clients by name, email, lifecycle, billing, or service plan',
        { assistantModule: 'agency', serviceId: 'agency', keywords: ['search agency clients', 'find agency client', 'buscar clientes agencia', 'buscar cliente agencia', 'client search', 'managed clients', 'billing mode', 'lifecycle', 'service plan'] },
    ),
    actionCommand(
        'action:agency-performance-summary',
        'Summarize Agency Performance',
        'Use Agency Engine to summarize portfolio health, MRR, revenue, usage, reports, and operating blockers.',
        'Summarize agency performance and blockers',
        { assistantModule: 'agency', serviceId: 'agency', keywords: ['agency performance', 'performance agency', 'mrr', 'revenue', 'usage', 'blockers', 'salud agencia', 'metricas agencia', 'portfolio health'] },
    ),
    actionCommand(
        'action:agency-create-report',
        'Create Agency Report',
        'Use Agency Engine to create a draft client or portfolio report with AI summary and activity audit.',
        'Create an agency report',
        { assistantModule: 'agency', serviceId: 'agency', keywords: ['agency report', 'client report', 'monthly report', 'reporte agencia', 'reporte cliente', 'executive summary', 'activity audit'] },
    ),
    actionCommand(
        'action:agency-transfer-project',
        'Transfer Agency Project',
        'Use Agency Engine to transfer an agency-owned project draft to a managed client with approval.',
        'Transfer an agency project to a managed client',
        { assistantModule: 'agency', serviceId: 'agency', keywords: ['transfer project', 'project transfer', 'transferir proyecto', 'copiar proyecto', 'managed client', 'approval request', 'client approval'] },
    ),
    actionCommand(
