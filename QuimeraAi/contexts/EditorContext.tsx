...
import { useEditorAdmin } from './editor/useEditorAdmin';
import { useEditorComponents } from './editor/useEditorComponents';
...
💬 **¿En qué te ayudo hoy?**`,
    ...
    // Components — Delegated to useEditorComponents hook
    const componentsHook = useEditorComponents({ user, userRole: userDocument?.role || '' });
    const {
