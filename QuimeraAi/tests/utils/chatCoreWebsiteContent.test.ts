    ...
    return {
        ...
        data: {
            hero: {
                ...
                subtitle: 'Reservas privadas y cenas al carbon en San Juan.',
            ...
            services: {
                ...
                items: [
                    ...
                    { name: 'Eventos privados', description: 'Menus para celebraciones.' },
                ],
            },
            footer: {
...
\`\`\`json
{
  "assistantReply": "Ya prepare el borrador.",
  "ready": true,
  "draft": {
    ...
    "faqs": [
      { "question": "Aceptan grupos?", "answer": "Si, con reserva previa." }
    ],
    "knowledgeDocument": {
...
\`\`\`
        ...
        expect(result.assistantReply).toBe('Ya prepare el borrador.');
