...
export function normalizeString(value: unknown, maxLength = 2000): string | undefined {
...
export function googleRedirectUri(req: IncomingMessage): string {
...
export function safeReturnUrl(req: IncomingMessage, value: unknown): string {
...
export function redirectWithStatus(res: ServerResponse, returnUrl: string, params: Record<string, string>): void {
