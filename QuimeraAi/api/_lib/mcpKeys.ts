...
export function createMcpApiKey(): { apiKey: string; keyHash: string; keyPrefix: string; keyPreview: string } {
...
export function normalizeRequestedScopes(scopes: unknown): string[] {
...
export async function assertUserTenantAccess(
  supabase: SupabaseClient,
  userId: string,
  tenantId: string,
): Promise<void> {
