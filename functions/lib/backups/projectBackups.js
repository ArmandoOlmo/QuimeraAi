...
exports.cleanupOldBackups = exports.restoreProjectFromBackup = exports.backupAllProjects = void 0;
 ...
 */
exports.backupAllProjects = functions.pubsub
    .schedule('0 */6 * * *')
            ...
            try {
                ...
                for (const projectDoc of projectsSnapshot.docs) {
                    try {
                        ...
                        if (projectData.status === 'Template')
                            continue;
 ...
 */
exports.restoreProjectFromBackup = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
    ...
    try {
        ...
        const isSuperAdmin = userDoc.exists && ['SuperAdmin', 'superadmin', 'Owner', 'owner'].includes(userDoc.data()?.role || '');
...
//# sourceMappingURL=projectBackups.js.map