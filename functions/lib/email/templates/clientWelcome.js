...
exports.getClientWelcomeTemplate = getClientWelcomeTemplate;
exports.getClientWelcomeTextVersion = getClientWelcomeTextVersion;
exports.getClientWelcomeSubject = getClientWelcomeSubject;
/**
 * Generate HTML email template for client welcome
 */
function getClientWelcomeTemplate(data) {
 ...
 */
function getClientWelcomeTextVersion(data) {
    const setupSteps = data.setupSteps || [
        'Completa tu perfil personal',
        'Explora tu dashboard personalizado',
        'Revisa las herramientas disponibles',
 ...
 */
function getClientWelcomeSubject(data) {
    return `¡Bienvenido a ${data.clientName}! Tu plataforma está lista 🚀`;
}
//# sourceMappingURL=clientWelcome.js.map